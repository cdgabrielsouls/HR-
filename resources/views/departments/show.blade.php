            ...
            <nav class="flex items-center gap-px">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-[120%] left-1/2 -translate-x-1/2 translate-y-2.5 w-[220px] bg-[#132B52] rounded-[18px] shadow-[0_20px_45px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(21,21,21,0.7)] p-2.5 opacity-0 invisible transition-all duration-300 z-[999] group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
                        <a href="{{ route('employees.index') }}" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Employee List</a>
                        <a href="{{ route('departments.index') }}" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Department List</a>
                    </div>
                </div>

                <div class="relative group">
                    <a href="{{ route('onboarding.step1') }}" class="flex items-center gap-2 text-white text-[20px] no-underline px-[18px] py-[10px] rounded-full transition-all duration-[250ms] ease-in-out group-hover:text-[#66A6FF] group-hover:bg-[#1B3A6B] group-hover:-translate-y-px group-hover:font-bold active:scale-[0.97]">
                        Employee Onboarding
                    </a>
                </div>
