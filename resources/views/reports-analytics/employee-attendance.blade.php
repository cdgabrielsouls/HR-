...
<body class="min-h-screen bg-[#1B3A6B] text-slate-200">
  ...
  <div class="w-full px-6 py-8">
    ...
    <nav class="mb-1 text-xs text-slate-400">
      <a href="#" class="hover:text-slate-200">Attendance</a>
      <span class="mx-1">&gt;</span>
      <a href="#" class="hover:text-slate-200">Attendance Record</a>
      <span class="mx-1">&gt;</span>
      <span class="text-sky-400">Attendance Record</span>
    </nav>

    <!-- Header -->
    <div class="mb-6 flex flex-wrap items-start justify-between gap-3">
      <div>
        <h1 class="text-xl font-semibold text-white">Attendance Record</h1>
        <p class="mt-1 text-sm text-slate-400">Views attendance details and history of the employee.</p>
      </div>
      <div class="flex items-center gap-3">
    ...
    <div class="mb-6 flex flex-wrap items-center gap-6 rounded-xl bg-[#111a3a] px-6 py-5 ring-1 ring-white/5" id="profile-card">
      <!-- filled by JS -->
    </div>
    ...
    <div class="overflow-hidden rounded-xl bg-[#0f1732] ring-1 ring-white/5">
      <div class="overflow-x-auto">
        <table class="w-full text-left text-sm">
          <thead>
            <tr class="border-b border-white/5 bg-[#111a3a] text-xs uppercase tracking-wide text-slate-400">
