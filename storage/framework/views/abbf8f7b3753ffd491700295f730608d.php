...
<body class="font-sans bg-[#18386d] text-white m-0 p-0">
    ...
    <!-- =====================================================
            TOP NAVBAR
        ====================================================== -->
    <header class="h-[150px] bg-[#132B52] border-b border-white/[0.03] flex items-center justify-between pl-px pr-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] z-10">

        <!-- Left -->
        <div class="flex items-center">
            <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-[86px] w-auto object-contain block" alt="Header Logo">
        </div>
        ...
        <div class="flex items-center gap-7">
            <nav class="flex items-center gap-px">
                ...
                <div class="relative group">
                    <a href="dashboard" class="flex items-center gap-2 text-white text-[20px] no-underline px-[18px] py-[10px] rounded-full transition-all duration-[250ms] ease-in-out group-hover:text-[#66A6FF] group-hover:bg-[#1B3A6B] group-hover:-translate-y-px group-hover:font-bold active:scale-[0.97]">
                        Dashboard
                    </a>
                </div>

                <div class="relative group">
                    <a href="#" class="flex items-center gap-2 text-white text-[20px] no-underline px-[18px] py-[10px] rounded-full transition-all duration-[250ms] ease-in-out group-hover:text-[#66A6FF] group-hover:bg-[#1B3A6B] group-hover:-translate-y-px group-hover:font-bold active:scale-[0.97]">
                        Workforce
                        <svg class="w-3.5 h-3.5 opacity-80 transition-transform duration-[280ms] group-hover:rotate-180 group-hover:opacity-100" viewBox="0 0 24 24" fill="none">
                            <path d="M6 9L12 15L18 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>

                    <div class="absolute top-[120%] left-1/2 -translate-x-1/2 translate-y-2.5 w-[220px] bg-[#132B52] rounded-[18px] shadow-[0_20px_45px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(21,21,21,0.7)] p-2.5 opacity-0 invisible transition-all duration-300 z-[999] group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
                        <a href="<?php echo e(route('employees.index')); ?>" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Employee List</a>
                        <a href="<?php echo e(route('departments.index')); ?>" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Department List</a>
                    </div>
                </div>

                <div class="relative group">
                    <a href="<?php echo e(route('onboarding.step1')); ?>"class="flex items-center gap-2 text-white text-[20px] no-underline px-[18px] py-[10px] rounded-full transition-all duration-[250ms] ease-in-out group-hover:text-[#66A6FF] group-hover:bg-[#1B3A6B] group-hover:-translate-y-px group-hover:font-bold active:scale-[0.97]">
                        Employee Onboarding
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-[120%] left-1/2 -translate-x-1/2 translate-y-2.5 w-[220px] bg-[#132B52] rounded-[18px] shadow-[0_20px_45px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(21,21,21,0.7)] p-2.5 opacity-0 invisible transition-all duration-300 z-[999] group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
                        <a href="#" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Placeholder 1</a>
                        <a href="#" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Placeholder 2</a>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-[120%] left-1/2 -translate-x-1/2 translate-y-2.5 w-[220px] bg-[#132B52] rounded-[18px] shadow-[0_20px_45px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(21,21,21,0.7)] p-2.5 opacity-0 invisible transition-all duration-300 z-[999] group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
                        <a href="#" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Placeholder 1</a>
                        <a href="#" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Placeholder 2</a>
                        <a href="#" class="block no-underline text-[#C9DAF8] px-3.5 py-[11px] rounded-[10px] text-[13px] font-medium transition-colors duration-200 hover:bg-[#f3f6fb] hover:text-[#2D7EFF]">Placeholder 3</a>
                    </div>
                </div>

            </nav>

            <div class="w-11 h-11 rounded-full grid place-items-center bg-white/[0.06] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]" aria-label="Profile">
    ...
    <div class="w-[96.82%] max-w-[1859px] mx-auto">
        ...
        <form method="GET" action="<?php echo e(route('employees.index')); ?>" class="flex justify-start items-center gap-5 py-2.5">
            ...
            <div class="relative w-[180px] flex-none">
                <select
                    ...
                    <option value="id_asc" <?php echo e(request('sort') == 'id_asc' ? 'selected' : ''); ?>>
                        Employee ID (Ascending)
                    </option>

                    <option value="id_desc" <?php echo e(request('sort') == 'id_desc' ? 'selected' : ''); ?>>
                        Employee ID (Descending)
                    </option>

                    <option value="department_asc" <?php echo e(request('sort') == 'department_asc' ? 'selected' : ''); ?>>
                        Department (A-Z)
                    </option>

                    <option value="department_desc" <?php echo e(request('sort') == 'department_desc' ? 'selected' : ''); ?>>
                        Department (Z-A)
                    </option>

                    <option value="position_asc" <?php echo e(request('sort') == 'position_asc' ? 'selected' : ''); ?>>
                        Position (A-Z)
                    </option>

                    <option value="position_desc" <?php echo e(request('sort') == 'position_desc' ? 'selected' : ''); ?>>
                        Position (Z-A)
                    </option>
                ...
                <tbody>
                    ...
                    <tr class="border-t border-white/[0.18] transition-colors duration-[250ms] hover:bg-[#21457f]">
                        ...
                        <td class="p-4 text-[0.84375rem] text-center border-r border-white/[0.12] font-extralight w-[23%]">
                            ...
                            ?>
                            <i class="fa-solid fa-circle-user text-2xl <?php echo e($genderClass); ?> mr-2"></i>
                            <?php echo e('2026' . str_pad($employee->id, 4, '0', STR_PAD_LEFT)); ?>

                        </td>

                        <td class="p-4 text-[0.84375rem] text-center border-r border-white/[0.12] font-extralight w-[23%]"><?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?></td>

                        <td class="p-4 text-[0.84375rem] text-center border-r border-white/[0.12] font-extralight w-[23%]"><?php echo e($employee->department); ?></td>

                        <td class="p-4 text-[0.84375rem] text-center border-r border-white/[0.12] font-extralight w-[23%]"><?php echo e($employee->position); ?></td>

                        <td class="p-4 text-[0.84375rem] text-center font-extralight w-[15%]">
                            <a href="<?php echo e(route('employees.show', $employee->id)); ?>" class="inline-block bg-[#132B52] text-white no-underline px-[21px] py-1.5 rounded-xl text-[0.6875rem] transition-all duration-[250ms] hover:bg-[#2e5ca3] hover:-translate-y-px">
                                View
                            </a>
                        </td>
...
</html><?php /**PATH C:\Users\cjjamie\Desktop\Nexora\hr-system\resources\views/employees/index.blade.php ENDPATH**/ ?>